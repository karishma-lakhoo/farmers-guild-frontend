            ...
            <View style={styles.header}>
                <View>
                    <View style={{flexDirection: 'row'}}>
                        ...
                        <Text style={{fontSize: 28, fontWeight:'bold', marginLeft:10}}>User</Text>
                    </View>
                    <Text style={{marginTop:5,fontSize:22,color:COLORS.grey}}>What do you want to plant today?</Text>
                </View>
            </View>
